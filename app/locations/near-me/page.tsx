...
export default function NearMePage() {
  ...
  return (
    <Shell>
      <div className="mb-6">
        <h1 className="text-3xl font-semibold text-slate-950">Offices Near You</h1>
      ...
      {isFetching && <p className="rounded-lg bg-white p-4">Finding nearby offices...</p>}
      ...
      {geo.position && !isFetching && data.length === 0 && <p className="rounded-lg bg-white p-4">No nearby offices found.</p>}
